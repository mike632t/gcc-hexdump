 ...
 * Copyright(C) 2023   MT
 *  
 * Reads a text file and substitutes spaces for tabs.
 *
...
void v_about() /* Display help text */
{
   ...
   fprintf(stdout, "Displays FILE(s) replacing tabs with spaces.\n\n");
